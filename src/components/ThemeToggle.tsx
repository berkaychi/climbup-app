...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      data-oid="fbbyqe."
    >
      <div className="relative w-6 h-6" data-oid="ps-cpwd">
        {/* Sun Icon */}
        <svg
      ...
      {/* Tooltip */}
      <span
        className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 bg-gray-800 dark:bg-gray-700 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10"
        data-oid="lvekmv0"
      >
