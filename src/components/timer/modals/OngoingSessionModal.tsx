  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="space-y-4 mb-6" data-oid="gyiww1q">
          <div
            className="bg-orange-50 dark:bg-orange-900/30 rounded-xl p-4"
            data-oid="c0-16rf"
          >
            <div className="text-center" data-oid="wjuq:g8">
              <div
              ...
              >
                Durum:{" "}
                <span className="font-medium" data-oid=".7jaqcb">
                  {getStatusText()}
                </span>
              </div>
              <div
          ...
          <div
            ...
            data-oid="b4ulqgk"
          >
            <p className="mb-2" data-oid="1l0_iw4">
              Bu oturuma devam etmek istiyor musunuz?
            </p>
            <p
        ...
        <div className="flex gap-3" data-oid="p2iqcer">
          <button
            onClick={onCancel}
