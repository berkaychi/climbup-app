...
const LoginPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-6 right-6 z-20" data-oid="i_-5hi1">
        <ThemeToggle data-oid="lswcrrf" />
      </div>
      {/* Merkezi Kart */}
      <div
      ...
      >
        ...
        ></div>
        {/* ClimbUp Logo */}
        <div className="text-center mb-8 relative z-10" data-oid="p_:ok82">
          <h1
        ...
        {/* Giriş Formu */}
        <div className="relative z-10" data-oid="481nz5a">
          <h2
          ...
          >
            ...
            <div data-oid="yfpw0j1">
              ...
              <div className="relative" data-oid="3kmmdhh">
                <input
            ...
            <div
              ...
              data-oid="pryn__s"
            >
              <div className="flex items-center" data-oid="lkbdixc">
                <input
                  id="remember-me"
                  name="remember-me"
                  type="checkbox"
              ...
              <div className="text-sm" data-oid="jvhrtnh">
                <Link
            ...
            {error && (
              <div
                ...
                data-oid="h-exox8"
              >
                <div className="flex" data-oid="pea:krn">
                  <svg
                  ...
                  >
                    ...
                    />
                    <path
                      d="M12 13c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1 1z"
                      data-oid="wtvl_c7"
                    />
                  </svg>
                  <div className="ml-3" data-oid="iprd50k">
                    <p
          ...
          {/* Sosyal Giriş */}
          <div className="mt-8" data-oid="qlo8nr.">
            <div className="relative" data-oid=":gt.7b6">
              <div
            ...
            <div className="mt-6 grid grid-cols-2 gap-3" data-oid="b2xuv6u">
              <button
                type="button"
          ...
          {/* Kayıt Ol Linki */}
          <div className="mt-8 text-center" data-oid="k03q9dr">
            <p className="text-gray-600 dark:text-gray-400" data-oid="pa-07co">
              Hesabın yok mu?{" "}
              <Link
                href="/register"
                className="font-medium text-orange-600 dark:text-orange-400 hover:text-orange-500 dark:hover:text-orange-300 transition-colors duration-200"
